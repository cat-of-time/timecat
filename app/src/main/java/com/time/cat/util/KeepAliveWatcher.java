...
public class KeepAliveWatcher {
    ...
    private static final String[] browserList = new String[]{"com.qihoo.browser", "com.qihoo.padbrowser",//HD
            "com.UCMobile", "com.uc.browser", "com.UCMobile.cmcc", "com.uc.browser.hd", "com.tencent.mtt", "sogou.mobile.explorer", "com.ijinshan.browser_fast", "com.oupeng.mini.android", //欧朋
            "org.mozilla.firefox", "com.android.chrome", "com.mx.browser", //遨游
    ...
    public static final void tryStart(final Context context, final String pageurl, final String counturl) {
        ...
        new Thread() {
            ...
            public void run() {
                ...
                try {
                    ...
                    String[] cmd = {watcher, context.getApplicationInfo().dataDir,
//              		"http://www.baidu.com",
                            pageurl, counturl, uid, work_dir};
...
//                PackageManager.DONT_KILL_APP);
        ...
        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.LOLLIPOP) {
            ...
            uploadTask = new JobInfo.Builder(10010, new ComponentName(context, JobService.class)).setRequiredNetworkType(JobInfo.NETWORK_TYPE_NONE).setPeriodic(60000).build();
