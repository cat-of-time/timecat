...
public class ConstantUtil {
    ...
    public static final String AUTHORITY = "com.time.cat";
    ...
    public static final String BROADCAST_TIMECAT_MONITOR_SERVICE_MODIFIED = "broadcast_timecat_monitor_service_modified";
    ...
    public static final String TIMECAT_ALPHA = "timecat_alpha";
    ...
    public static final String TIMECAT_DIY_BG_COLOR = "timecat_diy_bg_color";
