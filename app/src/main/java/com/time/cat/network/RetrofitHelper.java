package com.time.cat.network;

import com.google.gson.Gson;
import com.google.gson.GsonBuilder;
import com.time.cat.network.api.ImageUploadService;
import com.time.cat.network.api.MicSoftOcrService;
import com.time.cat.network.api.NoteService;
import com.time.cat.network.api.OcrService;
import com.time.cat.network.api.PicUploadService;
import com.time.cat.network.api.TaskService;
import com.time.cat.network.api.TranslationService;
import com.time.cat.network.api.UserService;
import com.time.cat.network.api.WordSegmentService;
...
import static com.time.cat.network.ConstantURL.BASE_URL;
import static com.time.cat.network.ConstantURL.IMAGE_UPLOAD_URL;
import static com.time.cat.network.ConstantURL.MICSOFT_OCR_URL;
import static com.time.cat.network.ConstantURL.OCR_URL;
import static com.time.cat.network.ConstantURL.PIC_UPLOAD_URL;
import static com.time.cat.network.ConstantURL.SEGMENT_URL;
import static com.time.cat.network.ConstantURL.YOUDAO_URL;
