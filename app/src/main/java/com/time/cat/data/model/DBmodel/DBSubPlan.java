...
public class DBSubPlan implements Serializable{
    ...
    public void setPlan(DBPlan plan) {
        this.plan = plan;
    }
    //</editor-fold desc="getter and setter">
    ...
    public String toString() {
        return "DBSubPlan{" + "id=" + id + ", url='" + url + '\'' + ", title='" + title + '\'' + ", content='" + content + '\'' + ", owner='" + owner + '\'' + ", created_datetime='" + created_datetime + '\'' + ", update_datetime='" + update_datetime + '\'' + ", color=" + color + ", tasks=" + tasks + ", user=" + user + ", plan=" + plan + '}';
    }
}
