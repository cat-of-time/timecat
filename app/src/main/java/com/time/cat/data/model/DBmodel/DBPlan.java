...
public class DBPlan implements Serializable {
    ...
    public String toString() {
        return "DBPlan{" + "id=" + id + ", url='" + url + '\'' + ", title='" + title + '\'' + ", content='" + content + '\'' + ", owner='" + owner + '\'' + ", created_datetime='" + created_datetime + '\'' + ", update_datetime='" + update_datetime + '\'' + ", color=" + color + ", image='" + image + '\'' + ", coverImageUrl='" + coverImageUrl + '\'' + ", sub_plans=" + sub_plans + ", is_star=" + is_star + '}';
    }
}
