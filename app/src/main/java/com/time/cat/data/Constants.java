...
public class Constants {
    ...
    public static final String MY_GITHUB = "http://github.com/zeleven";
    public static final String MY_ZHIHU = "https://www.zhihu.com/people/zheng-zheng-shu-36";
    public static final String PROJECT_PAGE_URL = "https://github.com/zeleven/mua";
