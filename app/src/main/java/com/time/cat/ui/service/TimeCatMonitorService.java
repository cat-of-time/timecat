...
public class TimeCatMonitorService extends AccessibilityService {
    ...
    private static final String TAG = "TimeCatMonitorService";
    ...
    private ArcTipViewController.ActionListener actionListener = new ArcTipViewController.ActionListener() {
        ...
        public void isShow(boolean isShow) {
            isRun = isShow;
            int text = isShow ? R.string.timecat_open : R.string.timecat_close;
            ToastUtil.ok(text);
        }
...
//                isScreenOn=true;
                ...
                // 锁屏
                Intent alive = new Intent(TimeCatMonitorService.this, KeepAliveActivity.class);
    ...
    public static String getVirtualNavigationKey(Context paramContext, String paramString1, String paramString2, String paramString3) {
        try {
            Resources packageManager = paramContext.getPackageManager().getResourcesForApplication(paramString2);
            return packageManager.getString(packageManager.getIdentifier(paramString1, "string", paramString2));
            ...
            keepOpenThread = new Thread(new Runnable() {
                ...
                public void run() {
                    ...
                    try {
                        ...
                        String service = TimeCatApp.getInstance().getPackageName() + "/" + TimeCatMonitorService.class.getCanonicalName();
    ...
    public void onDestroy() {
        ...
        ArcTipViewController.getInstance().remove();
        try {
            unregisterReceiver(timeCatBroadcastReceiver);
...
//            startActivity(intent);
    ...
    private void UniversalCopy() {
        ...
        if (!isSuccess) {
            if (!TimeCatMonitorService.isAccessibilitySettingsOn(this)) {
                ToastUtil.w(R.string.error_in_permission);
            } else {
                ToastUtil.e(R.string.error_in_copy);
            }
