...
public class FlipMenuView extends View {
    ...
    public FlipMenuView(Context context, Window window, View parentView) {
        super(context);
    ...
    public static class Builder {
        ...
        public FlipMenuView create() {
            FlipMenuView flipShare = new FlipMenuView(mActivity.getBaseContext(), mActivity.getWindow(), mParentView);
