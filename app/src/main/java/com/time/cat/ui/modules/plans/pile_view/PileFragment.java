...
public class PileFragment extends BaseLazyLoadFragment<PileMVP.View, PilePresenter> implements PlansFragment.OnScrollBoundaryDecider{
    ...
    VerticalTransitionLayout timeView;
    @BindView(R.id.title)
    HorizontalTransitionLayout title;
    ...
    public void initView() {
        ...
        pileLayout.setAdapter(new PileLayout.Adapter() {
            ...
            public void bindView(View view, int position) {
                ...
                Glide.with(getActivity()).load(dataList.get(position).getCoverImageUrl()).into(viewHolder.imageView);
            }
    ...
    private void initSecene(int position) {
        ...
        bottomView.firstInit(dataList.get(position).getCoverImageUrl());
    ...
    private void transitionSecene(int position) {
        ...
        bottomView.saveNextPosition(position, dataList.get(position).getCoverImageUrl());
    ...
    private void initDataList() {
        ...
        try {
            InputStream in = getContext().getAssets().open("preset.json");
