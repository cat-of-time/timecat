package com.time.cat.ui.widgets.timecat;
...
public class TimeCatLayout extends ViewGroup implements TimeCatHeader.ActionListener, NestedScrollingChild {
    ...
    private void initView(AttributeSet attrs) {
        if (attrs != null) {
            ...
            mItemSpace = typedArray.getDimensionPixelSize(R.styleable.TimeCatLayout_itemSpace, getResources().getDimensionPixelSize(R.dimen.big_bang_default_item_space));
            mLineSpace = typedArray.getDimensionPixelSize(R.styleable.TimeCatLayout_lineSpace, getResources().getDimensionPixelSize(R.dimen.big_bang_default_line_space));

            mTextColorRes = typedArray.getResourceId(R.styleable.TimeCatLayout_textColor, DEFAULT_TEXT_COLOR_RES);
            mTextSize = (int) ViewUtil.px2sp(typedArray.getDimension(R.styleable.TimeCatLayout_textSize, ViewUtil.sp2px(DEFAULT_TEXT_SIZE)));
            mTextBgRes = typedArray.getResourceId(R.styleable.TimeCatLayout_textBackground, DEFAULT_TEXT_BG_RES);
            mSectionTextBgRes = typedArray.getResourceId(R.styleable.TimeCatLayout_sectionTextBackground, DEFAULT_SECTION_TEXT_BG_RES);
            typedArray.recycle();
