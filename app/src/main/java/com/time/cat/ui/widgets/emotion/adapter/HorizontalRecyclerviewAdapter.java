...
public class HorizontalRecyclerviewAdapter extends RecyclerView.Adapter<HorizontalRecyclerviewAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        ...
        if (model.isSelected) {
            holder.imageBtn.setBackgroundColor(context.getResources().getColor(R.color.blue));
        } else {
            holder.imageBtn.setBackgroundColor(context.getResources().getColor(R.color.black));
        }
