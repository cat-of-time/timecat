...
public class ReminderNotification {
    ...
    public static void notify(final Context context, final String title, DBRoutine r, List<DBTaskItem> doses, LocalDate date, Intent intent, boolean lost) {
        ...
        options.picture = getLargeIcon(context.getResources(), r.user());
    ...
    private static void notify(final Context context, int id, final String title, Pair<Intent, Intent> actionIntents, Intent intent, NotificationOptions options) {
        ...
        int ic = options.lost ? R.drawable.ic_arrow_left_end_white : R.drawable.ic_arrow_right_end_white;
    ...
    private static Notification buildNotification(Context context, NotificationOptions options) {
        ...
        final NotificationCompat.Builder builder = new NotificationCompat.Builder(context)
                ...
                .setSmallIcon(options.lost ? R.drawable.ic_arrow_left_end_white : R.drawable.ic_arrow_right_end_white).setContentTitle(options.title).setContentText(options.text).setPriority(options.insistent ? NotificationCompat.PRIORITY_MAX : NotificationCompat.PRIORITY_DEFAULT)
                ...
                .setPriority(Notification.PRIORITY_DEFAULT).setVibrate(new long[]{1000, 200, 500, 200, 100, 200, 1000}).setSound(options.ringtone)
...
//        }
    ...
    private static Pair<Intent, Intent> getIntentsForRoutine(Context context, DBRoutine r, LocalDate date) {
        ...
        delay.putExtra(TimeCatApp.INTENT_EXTRA_ROUTINE_ID, r.getId());
        ...
        cancel.putExtra(TimeCatApp.INTENT_EXTRA_ACTION, TimeCatApp.ACTION_CANCEL_ROUTINE);
        cancel.putExtra(TimeCatApp.INTENT_EXTRA_ROUTINE_ID, r.getId());
